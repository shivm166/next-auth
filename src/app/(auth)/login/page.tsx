  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4">
      <div className="w-full max-w-[400px]">
        ...
        {/* Top Tab Switcher - Same to Same Design */}
        <div className="flex w-full mb-10 border-b border-gray-100">
          <div className="flex-1 flex justify-center pb-3 border-b-2 border-blue-600 cursor-pointer">
            <span className="text-lg font-bold text-blue-600">Log in</span>
          </div>
          <Link href="/signup" className="flex-1 flex justify-center pb-3 border-b-2 border-transparent cursor-pointer hover:text-gray-600">
            <span className="text-lg font-bold text-gray-300">Sign up</span>
          </Link>
        </div>
